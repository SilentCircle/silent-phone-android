...
/**
 * Description of a specific {@link android.provider.ContactsContract.Data#_ID} item, with style information
...
public class DataAction implements Action {
    ...
    /**
     * Create an action from common {@link android.provider.ContactsContract.Data} elements.
     */
    public DataAction(Context context, DataItem item, DataKind kind) {
        ...
        final ComponentName smsComponent = null; // PhoneCapabilityTester.getSmsComponent(mContext);
        final boolean hasSms = false; // (smsComponent != null);
...
//            }
            ...
            if (isEmail || im.isProtocolValid()) {
                ...
                if (isEmail) {
                    ...
                    mSubtitle = LabelHelper.ImLabel.getProtocolLabel(context.getResources(), Im.PROTOCOL_GOOGLE_TALK,
                            null);
                    mDataUri = null;
                }
