...
// import com.silentcircle.contacts.ContactsActivity;
...
// import com.silentcircle.contacts.common.list.ShortcutIntentBuilder;
// import com.silentcircle.contacts.common.list.ShortcutIntentBuilder.OnShortcutIntentCreatedListener;
import com.silentcircle.contacts.model.account.AccountType;
// import com.silentcircle.contacts.model.account.AccountWithDataSet;
...
// import com.silentcircle.contacts.model.dataitem.RelationDataItem;
...
// import com.silentcircle.contacts.model.dataitem.WebsiteDataItem;
import com.silentcircle.common.util.DateUtils;
import com.silentcircle.common.util.MaterialColorMapUtils;
import com.silentcircle.common.util.MaterialColorMapUtils.MaterialPalette;
import com.silentcircle.common.util.ViewUtil;
// import com.silentcircle.contacts.detail.ContactDetailUtils;
import com.silentcircle.contacts.interactions.CalendarInteractionsLoader;
import com.silentcircle.contacts.interactions.CallLogInteractionsLoader;
import com.silentcircle.contacts.interactions.ContactDeletionInteraction;
import com.silentcircle.contacts.interactions.ContactInteraction;
// import com.silentcircle.contacts.interactions.SmsInteractionsLoader;
import com.silentcircle.contacts.quickcontactnew.ExpandingEntryCardView.Entry;
import com.silentcircle.contacts.quickcontactnew.ExpandingEntryCardView.EntryContextMenuInfo;
import com.silentcircle.contacts.quickcontactnew.ExpandingEntryCardView.EntryTag;
import com.silentcircle.contacts.quickcontactnew.ExpandingEntryCardView.ExpandingEntryCardViewListener;
...
import com.silentcircle.contacts.widget.MultiShrinkScroller;
import com.silentcircle.contacts.widget.MultiShrinkScroller.MultiShrinkScrollerListener;
import com.silentcircle.contacts.widget.QuickContactImageView;
...
import com.silentcircle.silentcontacts2.ScContactsContract.CommonDataKinds.Relation;
...
//import com.silentcircle.silentcontacts2.ScContactsContract.Contacts;
...
public class QuickContactActivityV21 extends ActionBarActivity {

    /**
     * QuickContacts immediately takes up the full screen. All possible information is shown.
     * This value for {@link com.silentcircle.silentcontacts2.ScContactsContract.QuickContact#EXTRA_MODE}
    ...
    private static final String CALL_ORIGIN_QUICK_CONTACTS_ACTIVITY = "com.silentcircle.contacts.quickcontactnew.QuickContactActivity";
...
//    private SelectAccountDialogFragmentListener mSelectAccountFragmentListener;
    ...
    private static final String KEY_LOADER_EXTRA_PHONES =
            QuickContactActivityV21.class.getCanonicalName() + ".KEY_LOADER_EXTRA_PHONES";
...
//    private static final int MAX_SMS_RETRIEVE = 3;
    ...
    private static final String KEY_LOADER_EXTRA_EMAILS =
            QuickContactActivityV21.class.getCanonicalName() + ".KEY_LOADER_EXTRA_EMAILS";
    ...
    final OnClickListener mEntryClickHandler = new OnClickListener() {
        ...
        public void onClick(View v) {
            ...
            if ((intentUri != null && intentUri.getScheme() != null &&
                    intentUri.getScheme().equals(Constants.SCHEME_SMSTO)) ||
    ...
    public boolean onContextItemSelected(MenuItem item) {
        ...
        switch (item.getItemId()) {
            ...
            case ContextMenuIds.SET_DEFAULT:
                final Intent setIntent = ScContactSaveService.createSetSuperPrimaryIntent(this,
                        menuInfo.getId());
                this.startService(setIntent);
                return true;
            case ContextMenuIds.CLEAR_DEFAULT:
                final Intent clearIntent = ScContactSaveService.createClearPrimaryIntent(this,
                        menuInfo.getId());
...
//    }
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        if (Build.VERSION.SDK_INT < Build.VERSION_CODES.LOLLIPOP) {
            Log.e(TAG, "This implementation of QuickContact does not support this Android version.");
            finish();
            return;
        }
        ...
        setContentView(R.layout.quickcontact_activity_new);
...
//        mSelectAccountFragmentListener.setQuickContactActivity(this);
    ...
    /**
     * Call the 'getColor() function via reflection helper
     *
     * NOTE: this is a not public interface - we only read some data via that interface,
     * don't set any states or data.
     *
     * @param filter the color filter
     * @return the color integer
     */
    private int getFilterColor(PorterDuffColorFilter filter) {
        Class<?> c = filter.getClass();
        try {
            java.lang.reflect.Method m = c.getMethod("getColor", int.class);
            m.setAccessible(true);
            Integer integer = (Integer)m.invoke(filter);
            return integer;
        } catch (Exception e) {
            android.util.Log.i(TAG, "Cannot call 'getColor': " + e);
        }
        return 0;
    }
...
//            savedInstanceState.putInt(KEY_THEME_COLOR, mColorFilter.getColor());
            savedInstanceState.putInt(KEY_THEME_COLOR, getFilterColor(mColorFilter));
        }
    }
...
//        NfcHandler.register(this, mLookupUri);   // SC-CHECK - enable after decision where to support 'share'
    }
    ...
    private void bindContactData(final Contact data) {
        ...
        mPhotoView.setIsBusiness(false /* mContactData.isDisplayNameFromOrganization()*/);
        mPhotoSetter.setupContactPhoto(data, mPhotoView);
        extractAndApplyTintFromPhotoViewAsynchronously();
        analyzeWhitenessOfPhotoAsynchronously();
        setHeaderNameText(ContactDetailDisplayUtils.getDisplayName(this, data).toString());
    ...
    private void startInteractionLoaders(Cp2DataCardModel cp2DataCardModel) {
        ...
        List<DataItem> phoneDataItems = dataItemsMap.get(Phone.CONTENT_ITEM_TYPE);
        final List<DataItem> sipDataItems = dataItemsMap.get(SipAddress.CONTENT_ITEM_TYPE);
        if (phoneDataItems == null)
            phoneDataItems = sipDataItems;
        else {
            if (sipDataItems != null)
                phoneDataItems.addAll(sipDataItems);
        }
        ...
        if (phoneDataItems != null) {
            ...
            for (int i = 0; i < phoneDataItems.size(); ++i) {
                DataItem di = phoneDataItems.get(i);
                if (di instanceof PhoneDataItem)
                    phoneNumbers[i] = ((PhoneDataItem)di).getNumber();
                else
                    phoneNumbers[i] = ((SipAddressDataItem)di).getSipAddress();
            }
        }
...
//        Trace.endSection();
    ...
    private void initializeNoContactDetailCard() {
        final Drawable phoneIcon = getResources().getDrawable(
                R.drawable.ic_phone_24dp, null).mutate();
        ...
        final Drawable emailIcon = getResources().getDrawable(
                R.drawable.ic_email_24dp, null).mutate();
...
// TODO: Silent text intent?            intent = ContactsUtils.buildImIntent(context, im).first;
            ...
            if (protocol == Im.PROTOCOL_CUSTOM) {
                ...
                subHeader = LabelHelper.ImLabel.getProtocolLabel(res, protocol,
                        im.getCustomProtocol()).toString();
                text = im.getData();
            } else {
                header = LabelHelper.ImLabel.getProtocolLabel(res, protocol,
                        im.getCustomProtocol()).toString();
...
//            }
            ...
            if (event.hasKindTypeColumn(kind)) {
                subHeader = LabelHelper.EventLabel.getTypeLabel(res, event.getKindTypeColumn(kind),
...
//            }
            ...
            if (!TextUtils.isEmpty(phone.getNumber())) {
                ...
                if (phone.hasKindTypeColumn(kind)) {
                    text = LabelHelper.PhoneLabel.getTypeLabel(res, phone.getKindTypeColumn(kind),
                            phone.getLabel()).toString();
                    primaryContentDescription.append(text).append(" ");
                }
                primaryContentDescription.append(header);
                icon = res.getDrawable(R.drawable.ic_phone_24dp, null);
                iconResourceId = R.drawable.ic_phone_24dp;
//                if (PhoneCapabilityTester.isPhone(context)) {
                    intent = ContactsUtils.getCallIntent(phone.getNumber());
//                }
                alternateIntent = new Intent(Intent.ACTION_SENDTO,
                        Uri.fromParts(Constants.SCHEME_SMSTO, phone.getNumber(), null));

// TODO - intent for silent text ?               alternateIcon = res.getDrawable(R.drawable.ic_message_24dp);
//                alternateContentDescription.append(res.getString(R.string.sms_custom, header));

                // Add video call button if supported
//                if (ContactsUtils.isVideoEnabled(context)) {
//                    thirdIcon = res.getDrawable(R.drawable.ic_videocam);
//                    thirdIntent = ContactsUtils.getVideoCallIntent(phone.getNumber(),
...
//                }
            ...
            if (!TextUtils.isEmpty(address)) {
                ...
                if (email.hasKindTypeColumn(kind)) {
                    text = LabelHelper.EmailLabel.getTypeLabel(res, email.getKindTypeColumn(kind),
                            email.getLabel()).toString();
                    primaryContentDescription.append(text).append(" ");
                }
                primaryContentDescription.append(header);
                icon = res.getDrawable(R.drawable.ic_email_24dp, null);
            ...
            if (!TextUtils.isEmpty(postalAddress)) {
                ...
                if (postal.hasKindTypeColumn(kind)) {
                    text = LabelHelper.StructuredPostalLabel.getTypeLabel(res,
                            postal.getKindTypeColumn(kind), postal.getLabel()).toString();
                    primaryContentDescription.append(text).append(" ");
                }
                primaryContentDescription.append(header);
// TODO - check if enable directions              alternateIntent =
            ...
            if (PhoneCapabilityTester.isSipPhone(context)) {
                ...
                if (!TextUtils.isEmpty(address)) {
                    ...
                    if (sip.hasKindTypeColumn(kind)) {
                        text = LabelHelper.PhoneLabel.getTypeLabel(res,
                                sip.getKindTypeColumn(kind), sip.getLabel()).toString();
                        primaryContentDescription.append(text).append(" ");
                    }
                    primaryContentDescription.append(header);
                    icon = res.getDrawable(R.drawable.ic_dialer_sip_black_24dp, null);
...
//                        break;
    ...
    private final LoaderCallbacks<Contact> mLoaderContactCallbacks =
        ...
        public void onLoadFinished(Loader<Contact> loader, Contact data) {
            ...
            if (data.isNotFound()) {
                if (mHasAlreadyBeenOpened) {
                    ...
                    Toast.makeText(QuickContactActivityV21.this, R.string.invalidContactMessage,
        ...
        public Loader<Contact> onCreateLoader(int id, Bundle args) {
            ...
            return new ContactLoader(getApplicationContext(), mLookupUri,
                    true /*loadGroupMetaData*/, false /*loadStreamItems*/, false /*loadInvitableAccountTypes*/,
    ...
    private final LoaderCallbacks<List<ContactInteraction>> mLoaderInteractionsCallbacks =
        ...
        public Loader<List<ContactInteraction>> onCreateLoader(int id, Bundle args) {
            if (ConfigurationUtilities.mTrace) Log.v(TAG, "onCreateLoader");
...
//                    break;
                case LOADER_CALENDAR_ID:
                    if (ConfigurationUtilities.mTrace) Log.v(TAG, "LOADER_CALENDAR_ID");
                ...
                case LOADER_CALL_LOG_ID:
                    if (ConfigurationUtilities.mTrace) Log.v(TAG, "LOADER_CALL_LOG_ID");
    ...
    private void toggleStar(MenuItem starredMenuItem) {
        ...
        if (mContactData != null) {
            ...
            final Intent intent = ScContactSaveService.createSetStarredIntent(
                    QuickContactActivityV21.this, mContactData.getLookupUri(), !isStarred);
            startService(intent);
...
//        }
    ...
    private void shareContact() {
        final Uri lookupKey = mContactData.getLookupUri();
//        Uri shareUri = Uri.withAppendedPath(RawContacts.CONTENT_VCARD_URI, lookupKey);
        long rawContactId = ContentUris.parseId(lookupKey);
    ...
    public boolean onPrepareOptionsMenu(Menu menu) {
        if (mContactData != null) {
            ...
            shareMenuItem.setVisible(false /*isContactShareable()*/);  // SC-CHECK depending where to support 'share' enable it again
...
//                } else
                if (InvisibleContactUtil.isInvisibleAndAddable(mContactData, this)) {
