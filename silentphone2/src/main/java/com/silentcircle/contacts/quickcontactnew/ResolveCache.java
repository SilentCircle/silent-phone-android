...
/**
 * Internally hold a cache of scaled icons based on {@link android.content.pm.PackageManager}
 * queries, keyed internally on MIME-type.
 */
public class ResolveCache {
    /**
     * Specific list {@link android.content.pm.ApplicationInfo#packageName} of apps that are
     * prefered <strong>only</strong> for the purposes of default icons when
     * multiple {@link android.content.pm.ResolveInfo} are found to match. This only happens when
    ...
    /**
     * Cached entry holding the best {@link android.content.pm.ResolveInfo} for a specific
     * MIME-type, along with a {@link java.lang.ref.SoftReference} to its icon.
     */
    ...
    /**
     * Get the {@link com.silentcircle.contacts.quickcontactnew.ResolveCache.Entry} best associated with the given mimetype and intent,
    ...
    protected Entry getEntry(String mimeType, Intent intent) {
        ...
        // Silent Phone is always a SIP phone
...
//        }
    ...
    /**
     * Best {@link android.content.pm.ResolveInfo} when multiple found. Ties are broken by
     * selecting first from the {@link QuickContactActivityV21#sPreferResolve} list of
     ...
     * {@link android.content.Intent} disambiguation dialog.
     */
    ...
    /**
     * Check {@link android.content.pm.PackageManager} to see if any apps offer to handle the
     ...
     * based on the {@link android.content.pm.ResolveInfo} found through a
     * {@link android.content.pm.PackageManager} query.
     */
