 ...
 *
 * @deprecated use {@link com.silentcircle.contacts.model.RawContactModifier#getTypePrecedence} instead, since this
 *             list isn't {@link android.accounts.Account} based.
 */
@Deprecated
