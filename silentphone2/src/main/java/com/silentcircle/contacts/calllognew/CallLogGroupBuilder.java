...
public class CallLogGroupBuilder {
     ...
     * calls {@link com.silentcircle.contacts.calllognew.CallLogGroupBuilder.GroupCreator#addGroup(int, int, boolean)} on {@link #mGroupCreator} for each of
     * them.
     * <p>
     ...
     *
     * @see GroupingListAdapter#addGroups(android.database.Cursor)
     */
