...
//            CallerInfoCacheUtils.sendUpdateCallerInfoCacheIntent(this);
    ...
    public static Intent createNewRawContactIntent(Context context,  ArrayList<ContentValues> values,
            Class<? extends Activity> callbackActivity, String callbackAction, ComponentName cm) {
        ...
        if (cm == null) {
            callbackIntent = new Intent(context, callbackActivity);
        }
        else {
            callbackIntent = new Intent();
            callbackIntent.setComponent(cm);
        }
