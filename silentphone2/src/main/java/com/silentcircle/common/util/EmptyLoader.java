...
/**
 * A {@link android.content.Loader} only used to make use of the {@link android.app.Fragment#setStartDeferred}
 * feature from an old-style fragment which doesn't use {@link android.content.Loader}s to load data.
 *
...
public class EmptyLoader extends Loader<Object> {
    ...
    /**
     * {@link android.app.LoaderManager.LoaderCallbacks} which just generates {@link com.silentcircle.common.util.EmptyLoader}.  {@link #onLoadFinished}
