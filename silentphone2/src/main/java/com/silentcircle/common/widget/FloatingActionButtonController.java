...
public class FloatingActionButtonController {
    ...
    public FloatingActionButtonController(Activity activity, View container, View button) {
        ...
        if (Build.VERSION.SDK_INT >= Build.VERSION_CODES.LOLLIPOP) 
            ...
            mFabInterpolator = AnimationUtils.loadInterpolator(activity, android.R.interpolator.linear);
    ...
    /**
     * Resize width and height of the floating action bar container.
    ...
    public void scaleOut() {
        ...
        // obvious. We don't want it to scale, but the resizing the container is not as fast.
    ...
    private boolean isLayoutRtl() {
        return Build.VERSION.SDK_INT >= Build.VERSION_CODES.JELLY_BEAN_MR1 
                && mFloatingActionButtonContainer.getLayoutDirection() == View.LAYOUT_DIRECTION_RTL;
    }
}
