...
public class ViewDragHelper {
     ...
     * The callback's {@link com.silentcircle.silentphone2.views.ViewDragHelper.Callback#onEdgeTouched(int, int)} and
     * {@link com.silentcircle.silentphone2.views.ViewDragHelper.Callback#onEdgeDragStarted(int, int)} methods will only be invoked
     ...
     * but {@link com.silentcircle.silentphone2.views.ViewDragHelper.Callback#tryCaptureView(android.view.View, int)} will not be asked permission to
     * capture this view.
     *
     ...
     * The child order is determined using {@link com.silentcircle.silentphone2.views.ViewDragHelper.Callback#getOrderedChildIndex(int)}.
     *
     * @param x X position to test in the parent's coordinate system
     * @param y Y position to test in the parent's coordinate system
    ...
    /**
     * Prepares the {@link com.silentcircle.silentphone2.views.ViewDragHelper} for the beginning of a nested scroll.
     *
    ...
    /**
     * Informs the {@link com.silentcircle.silentphone2.views.ViewDragHelper} that a nested scroll has ended.
     *
     * @param target The child view that is dispatching the nested scroll.
     */
    ...
    /**
     * Update the {@link com.silentcircle.silentphone2.views.ViewDragHelper} with a new nested scrolling event.
     *
     * @param target The child view that is dispatching the nested scroll.
     * @param dx The x distance scrolled on the child, in pixels.
     * @param dy The y distance scroll on the child, in pixels.
     * @param consumed An int array for the {@link com.silentcircle.silentphone2.views.ViewDragHelper} to report back the scroll
