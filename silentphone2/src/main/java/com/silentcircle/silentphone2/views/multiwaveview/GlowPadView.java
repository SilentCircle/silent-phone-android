...
package com.silentcircle.silentphone2.views.multiwaveview;
...
public class GlowPadView extends View {
    ...
    private void computeInsets(int dx, int dy) {
        final int layoutDirection = (Build.VERSION.SDK_INT < Build.VERSION_CODES.JELLY_BEAN_MR1)? LAYOUT_DIRECTION_LTR :  getLayoutDirection();
    ...
    private void announceTargets() {
        ...
        if (utterance.length() > 0 && Build.VERSION.SDK_INT >= Build.VERSION_CODES.JELLY_BEAN) {
