...
public class OverlappingPaneLayout extends ViewGroup {
    private static final String TAG = "OverlappingPaneLayout";
...
//            Log.d(TAG, "++++ canSlide: " + canSlide + ", h-remaining: " + heightRemaining + ", lp-slideable: " + lp.slideable);
...
//        Log.d(TAG, "++++ slideOffPx: " + mSlideOffsetPx + ", slide range: " + mSlideRange + ", offset: " +mSlideOffset);
    }
...
//        Log.d(TAG, "++++ newTop: " + newTop + ", lpMargin: " + lp.topMargin + ", paddingTop: " + getPaddingTop());
...
//            Log.d(TAG, "++++ onPosition changed: " + top);
            onPanelDragged(top);
            invalidate();
        }
...
//            Log.d(TAG, "++++ clamp view, is nested: " + mIsInNestedScroll + ", top: " + top + ", dy: " + dy);
            final int newTop;
...
//            Log.d(TAG, "++++ clamp view, is newTop: " + newTop + ", bottom bound: " + bottomBound + ", top bound: " + topBound);
