 ...
 */
public class DialerDatabaseHelperOrig extends SQLiteOpenHelper {
    private static final String TAG = "DialerDatabaseHelper";
    private static final boolean DEBUG = false;

    private static DialerDatabaseHelperOrig sSingleton = null;
    ...
    public interface PhoneQuery {
       ...
       String[] PROJECTION = new String[] {
        ...
        String[] PROJECTION_16 = new String[] {
                Phone._ID,                          // 0
                Phone.TYPE,                         // 1
                Phone.LABEL,                        // 2
                Phone.NUMBER,                       // 3
                ...
                Phone.DISPLAY_NAME_PRIMARY,         // 6
                Phone.PHOTO_ID,                     // 7
                Data.LAST_TIME_CONTACTED,           // 8
                Data.TIMES_CONTACTED,               // 9
                Contacts.STARRED,                   // 10
                Data.IS_SUPER_PRIMARY,              // 11
                Contacts.IN_VISIBLE_GROUP,          // 12
                Data.IS_PRIMARY,                    // 13
        ...
        int PHONE_LAST_TIME_CONTACTED = 8;
        int PHONE_TIMES_USED = 9;
        int PHONE_TIMES_CONTACTED = 9;
        ...
        String SELECT_UPDATED_CLAUSE_16 =
                Data.LAST_TIME_CONTACTED + " > ?";
         ...
         */
        String SELECT_IGNORE_LOOKUP_KEY_TOO_LONG_CLAUSE =
                "length(" + Phone.LOOKUP_KEY + ") < 1000";

        String SELECTION = SELECT_UPDATED_CLAUSE + " AND " +
                SELECT_IGNORE_LOOKUP_KEY_TOO_LONG_CLAUSE;

        String SELECTION_16 = SELECT_UPDATED_CLAUSE_16 + " AND " +
                SELECT_IGNORE_LOOKUP_KEY_TOO_LONG_CLAUSE;
    }
    ...
    private static interface SmartDialSortingOrder {
        ...
        String TIME_SINCE_LAST_USED_MS = "( ?1 - " +
     ...
     */
    public static synchronized DialerDatabaseHelperOrig getInstance(Context context) {
        if (DEBUG) {
        ...
        if (sSingleton == null) {
            ...
            sSingleton = new DialerDatabaseHelperOrig(context.getApplicationContext(),
                    DATABASE_NAME);
        }
        return sSingleton;
    }
     ...
     */
    @VisibleForTesting
    static DialerDatabaseHelperOrig getNewInstanceForTest(Context context) {
        return new DialerDatabaseHelperOrig(context, null);
    }

    protected DialerDatabaseHelperOrig(Context context, String databaseName) {
        this(context, databaseName, DATABASE_VERSION);
    }

    protected DialerDatabaseHelperOrig(Context context, String databaseName, int dbVersion) {
    ...
    protected void insertUpdatedContactsAndNumberPrefix(SQLiteDatabase db,
        ...
        try {
            ...
            while (updatedContactCursor.moveToNext()) {
                ...
                insert.bindLong(7, updatedContactCursor.getLong(PhoneQuery.PHONE_LAST_TIME_USED)); // PHONE_LAST_TIME_CONTACTED
                insert.bindLong(8, updatedContactCursor.getInt(PhoneQuery.PHONE_TIMES_USED)); // PHONE_TIMES_CONTACTED
                ...
                final ArrayList<String> numberPrefixes = SmartDialPrefix.parseToNumberTokens(contactPhoneNumber);
    ...
    public void updateSmartDialDatabase() {
        ...
        synchronized(mLock) {
            ...
            if (Build.VERSION.SDK_INT >= Build.VERSION_CODES.JELLY_BEAN_MR2) {
                ...
                updatedContactCursor = mContext.getContentResolver().query(PhoneQuery.URI,
                        PhoneQuery.PROJECTION_16, PhoneQuery.SELECTION_16,
                        new String[]{lastUpdateMillis}, null);
            }
