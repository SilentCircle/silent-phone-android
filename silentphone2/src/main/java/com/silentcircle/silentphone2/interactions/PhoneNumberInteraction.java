 ...
 */
package com.silentcircle.silentphone2.interactions;
...
import com.silentcircle.common.Collapser.Collapsible;
...
//                        Intent.ACTION_SENDTO, Uri.fromParts("sms", phoneNumber, null));
                break;
            default:
                if (context instanceof OnPhoneNumberPickerActionListener) {
                    final OnPhoneNumberPickerActionListener listener = (OnPhoneNumberPickerActionListener)context;
...
//        DialerUtils.startActivityWithErrorToast(context, intent);
     ...
     */
    @VisibleForTesting
    void startInteraction(Uri uri, boolean useDefault) {
        if (mLoader != null) {
            mLoader.reset();
        }
