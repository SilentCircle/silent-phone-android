...
public abstract class PhoneFavoriteTileView extends ContactTileView {
    ...
    protected void onFinishInflate() {
        ...
        setOnLongClickListener(new OnLongClickListener() {
            ...
            public boolean onLongClick(View v) {
                ...
                view.startDrag(EMPTY_CLIP_DATA, new View.DragShadowBuilder(), DRAG_PHONE_FAVORITE_TILE, 0);
                return true;
            }
        });
    }
    ...
    public void loadFromContact(ContactEntry entry) {
        ...
        if (entry != null) {
            ...
            // TODO release: Just hide the view for now. For this to truly look like an empty row
    ...
    protected DefaultImageRequest getDefaultImageRequest(String displayName, String lookupKey) {
        return new DefaultImageRequest(displayName, lookupKey, ContactPhotoManagerNew.TYPE_DEFAULT,
