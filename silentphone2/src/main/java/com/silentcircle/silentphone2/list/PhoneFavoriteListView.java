...
public class PhoneFavoriteListView extends GridView implements OnDragDropListener,
    ...
    private static final String LOG_TAG = PhoneFavoriteListView.class.getSimpleName();
    ...
    private final DragDropController mDragDropController = new DragDropController(this);
     ...
     * offset to the top / bottom by {@link #getHeight} * {@link #BOUND_GAP_RATIO} pixels.
     */
    @SuppressWarnings("FieldCanBeLocal")
